...
@section('content')
    ...
    <x-breadcrumb title="Edit Sub-Category" pagetitle="Products" />
    ...
    <form action="{{ route('admin.subcategories.update', $subcategory) }}" method="POST" class="needs-validation" novalidate>
        @csrf
        @method('PUT') 
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="name-input"
                                ...
                                value="{{ old('name', $subcategory->name) }}" required> <div class="invalid-feedback">Please enter a sub-category name.</div>
                        </div>
                    </div>
                </div>
                <div class="text-end mb-3">
                    <button type="submit" class="btn btn-success w-sm">Update Sub-Category</button>
                </div>
            </div>
